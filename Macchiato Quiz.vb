Public Class MacchiattoQuiz
    ...
    Private Sub MacchiattoQuiz_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub Form9_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Dim readthis As New System.IO.StreamReader("Macchiato Questions Edit.txt")
    ...
    Private Sub btnnextq_Click(sender As System.Object, e As System.EventArgs) Handles btnnextq.Click
        ...
        Randomize() 'Display the next question'
        index = Rnd() * (quizdatabase.Count - 1) + 1
        readQuestion = quizdatabase.Item(index)
        lblquestion.Text = readQuestion.question
        Option1.Text = readQuestion.answer1
