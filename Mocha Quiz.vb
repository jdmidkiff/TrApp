Public Class MochaQuiz
    ...
    Dim guesses As Integer = 0 'Tracking incorrect answers'
    Dim qcounter As Integer 'Counting questions'
    Dim result As Integer 'Form closing event selection'

    Private Sub MochaQuiz_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Dim readthis As New System.IO.StreamReader("Mocha Questions.txt")
