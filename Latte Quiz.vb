Public Class LatteQuiz
    ...
    Private Sub LatteQuiz_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub Form5_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Dim readthis As New System.IO.StreamReader("Latte Questions.txt")
        Do While readthis.EndOfStream = False 'Read and load questions'
        ...
        readthis.Close() 'Display Question'
        Randomize()
    ...
    Private Sub btnnextq_Click(sender As System.Object, e As System.EventArgs) Handles btnnextq.Click
        ...
        If qcounter = 9 Then BtnFinish.Visible = True
        ...
        Randomize() 'To display the next question'
        index = Rnd() * (quizdatabase.Count - 1) + 1
        readQuestion = quizdatabase.Item(index)
        lblquestion.Text = readQuestion.question
        Option1.Text = readQuestion.answer1
    ...
    Private Sub BtnFinish_Click(sender As System.Object, e As System.EventArgs) Handles BtnFinish.Click
        TotalScore = TotalScore + score 'Stores updated score in Scoreboard.txt'
